  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">{t('settings.notifications.all_messages.title')}</Text>
        <Box gap="100">
          <Text size="T200">{t('settings.notifications.all_messages.badge')}</Text>
      ...
      >
        <SettingTile
          title={t('settings.notifications.all_messages.1_to_1_chats.title')}
      ...
      >
        <SettingTile
          title={t('settings.notifications.all_messages.1_to_1_chats_encrypted.title')}
          after={
      ...
      >
        <SettingTile
          title={t('settings.notifications.all_messages.rooms.title')}
      ...
      >
        <SettingTile
          title={t('settings.notifications.all_messages.rooms_encrypted.title')}
          after={
            <AllMessagesModeSwitcher
              pushRules={pushRules}
