  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">{t('settings.notifications.special_messages.title')}</Text>
        <Box gap="100">
          <Text size="T200">{t('settings.notifications.special_messages.badge')}</Text>
      ...
      >
        <SettingTile
          title={`${t('settings.notifications.special_messages.mention_user_id.title')} ("${userId}")`}
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
      ...
      >
        <SettingTile
          title={`${t('settings.notifications.special_messages.contains_displayname.title')} ${displayName ? `("${displayName}")` : ''}`}
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
      ...
      >
        <SettingTile
          title={`${t('settings.notifications.special_messages.contains_username.title')} ("${getMxIdLocalPart(userId)}")`}
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
      ...
      >
        <SettingTile
          title={t('settings.notifications.special_messages.mention_at_room.title')}
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
      ...
      >
        <SettingTile
          title={t('settings.notifications.special_messages.contains_at_room.title')}
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
