      ...
      fallback={() => (
        <SplashScreen>
          <Box direction="Column" grow="Yes" alignItems="Center" justifyContent="Center" gap="400">
            ...
            <Text>{ t('client.spec_versions.connecting_to_server') }</Text>
          </Box>
        </SplashScreen>
      )}
          ...
          <Box direction="Column" grow="Yes" alignItems="Center" justifyContent="Center" gap="400">
            <Dialog>
              <Box direction="Column" gap="400" style={{ padding: config.space.S400 }}>
                <Text>
                  { t('client.spec_versions.failed_to_connect_to_homeserver_network_down') }
                </Text>
                <Button variant="Critical" onClick={retry}>
                  <Text as="span" size="B400">
                    { t('client.spec_versions.retry_button') }
                  </Text>
                </Button>
                <Button variant="Critical" onClick={ignore} fill="Soft">
                  <Text as="span" size="B400">
                    { t('client.spec_versions.continue_button') }
                  </Text>
                </Button>
              </Box>
            </Dialog>
